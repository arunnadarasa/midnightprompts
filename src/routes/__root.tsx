...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Creative Midnight — 1,000 ZK hackathon ideas for Lovable" },
      { name: "twitter:description", content: "A browseable repo of 1,000 mega-prompts pairing ten creative disciplines with Midnight's private-by-default ZK primitives: Compact contracts, Lace wallet, private witnesses, and IPFS content. Built during the Creative AI & Quantum Hackathon." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/792e9a8b-2d0e-46f3-86c0-9bba0da5dad0" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/792e9a8b-2d0e-46f3-86c0-9bba0da5dad0" },
    ],
    links: [
      {
        rel: "stylesheet",
